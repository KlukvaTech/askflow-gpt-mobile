...
const DocsGPT = () => {
    ...
    const handleChooseDocument = async () => {
        try {
            const response = await axios.get(apiUrl + 'combine')
            ...
            const responseOptions = response.data.map((item) => item.docLink.startsWith('/app/application/indexes/local') ? item.name : null);
